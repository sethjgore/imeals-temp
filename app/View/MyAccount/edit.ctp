	...
	<div class="row-fluid show-grid">
		...
		<h3><?php echo __('Edit User'); ?></h3>
			...
			<div
				...
				<div class="controls">
					<?php echo $this->Form->input('first_name',array('div' => false,'label'=>false,'class' => 'input-large','error'=>false)); ?>
				</div>
			</div>
			...
			<div
				...
				<div class="controls">
					<?php echo $this->Form->input('last_name',array('div' => false,'label'=>false,'class' => 'input-large','error'=>false)); ?>
				</div>
			</div>
			
			<div
				class="control-group <?php if (array_key_exists('phone', $errors)){ echo 'error'; } ?>">
				<label for="inputPhone" class="control-label"><?php echo __('Phone'); ?><span
					style="color: red;">*</span>
				</label>
				<div class="controls">
