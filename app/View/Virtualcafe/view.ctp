<div class="virtualcafe view">
<h2><?php  echo __('Virtualcafe'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($virtualcafe['Virtualcafe']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($virtualcafe['Virtualcafe']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($virtualcafe['Virtualcafe']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Virtualcafe'), array('action' => 'edit', $virtualcafe['Virtualcafe']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Virtualcafe'), array('action' => 'delete', $virtualcafe['Virtualcafe']['id']), null, __('Are you sure you want to delete # %s?', $virtualcafe['Virtualcafe']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Virtualcafe'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Virtualcafe'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($virtualcafe['Order'])): ?>
	...
	<?php
		$i = 0;
		foreach ($virtualcafe['Order'] as $order): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($virtualcafe['TempOrder'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Address'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($virtualcafe['TempOrder'] as $tempOrder): ?>
		<tr>
