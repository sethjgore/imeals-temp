...
<div class="container">
	...
	<div class="row-fluid show-grid">
		<div class="span12">
			<button class="btn btn-success" type="button" onclick="syncAco();">
				<i class="icon-refresh icon-white"></i>
				<?php echo __('Sync New Actions'); ?>
			</button>
		</div>
	</div>
	<br />
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<th style="text-align: center; width: 300px;"><?php echo $this->Paginator->sort('user_email',_('User Email')); ?>
						</th>
						<th style="text-align: center;"><?php echo $this->Paginator->sort('user_name',_('Full Name')); ?>
						</th>
						<th style="text-align: center; width: 150px;"><?php echo $this->Paginator->sort('created',_('Created')); ?>
						</th>
				...
				<tbody>
					...
					<tr>
						...
						<?php if ($this->Acl->check('Permissions','userPermission','AuthAcl') == true){?>
						<td style="text-align: center;"><?php echo $this->Html->link(__('Permission'), array('action' => 'userPermission', $user['User']['id']),array('class'=>'btn btn-mini btn-primary')); ?>
						</td>
						<?php } ?>
					</tr>
					<?php endforeach; ?>
